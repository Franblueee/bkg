...
# nohup ./inference.sh > inference.log 2>&1 &
...
model_name="/work/work_fran/bkg/medqa/weights/1B-Instruct_100e"  # Specify your model name or path
output_dir="/work/work_fran/bkg/medqa/inference/1B-Instruct_100e"
